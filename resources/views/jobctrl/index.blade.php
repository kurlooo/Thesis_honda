...
{{--                        <td>{{ $job->pro_time }}</td>--}}
                        ...
                        <td>{{ $job->hour }} hour(s) and {{ $job->min }} minute(s)</td>
                        <td>{{ $job->tech_name }}</td>
                        <td>{{ $job->qc }}</td>
                        <td>{{ $job->rlsd }}</td>
                        <td>
...
{{--                            </div>--}}
                            ...
                            <div class="row ml-2">
                                    <div class="col-md-4 mb-4">
                                        <input id="hour" type="text" placeholder="Enter Hours" class="form-control @error('hour') is-invalid @enderror" name="hour" required >
                                        @error('hour')
                                        <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="col-md-4 mb-4">
                                        <input id="min" type="text" placeholder="Enter Minutes" class="form-control @error('min') is-invalid @enderror" name="min" required >
                                        @error('min')
                                        <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
